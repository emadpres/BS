...
int Revenge::alphabeta(RevPosition * position, int depth, int alpha, int beta)
{
...
MOVE Revenge::firstAlphabeta(RevPosition * position, int depth, int alpha, int beta)
{
	MOVE list[MAXMOVES];
	int i,numberOfMoves,value,localalpha=alpha,bestvalue=-INFINITY;
...
int Revenge::evaluation(RevPosition * position)
{
