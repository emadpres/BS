...
#Current supported operations, open, checkout/co, list/ls, update/up, commit/ci, status/stat, diff, info, add, revert, delete
#svn+ssh is our primary connection use case, however can connect to, and operate on a (local) file:/// URI as well

# requirement: all kind of OS
# needed library svn_wc
