...
ClassDeclaration :			S_CLASS ID OptionalSuperclass '{'	{ printf("Class{\n");}
							MemberDeclarations '}' ';'			{ printf("}C\n");}
;

OptionalSuperclass :		':' S_PUBLIC ID
							|
;
...
VariableDeclaration :		TypeName RestOfVariableDeclaration
;
...
DeclarationOrStatement : 	VariableDeclaration
							| KeywordStatement
							| OtherDeclarationOrStatement
;

PrimitiveDeclaration:		PrimitiveType RestOfVariableDeclaration 
;
...
Selection :					S_IF '(' Expression ')' Statement 
;
