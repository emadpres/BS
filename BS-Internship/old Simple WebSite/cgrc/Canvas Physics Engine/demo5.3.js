...
window.onload = function() {
    ...
    var temp = pr;
    for(var i=0;i<13;i++){
            var border = new Path(new Point(i*100+5,view.size.height - 250),new Point((i+1)*100-5,view.size.height - 250),new Point((i+1)*100-5,view.size.height),new Point(i*100+5,view.size.height));
              border.fillColor = new HsbColor(i/13 * 360, 0.6, 0.6);
...
//        particle2.inverseMass = 1/(i/5+0.1);
        ...
        pfr5.particleForceGenerator = new ParticleBuoyancy(20, 1, 250, 400+Math.random()*1200);
