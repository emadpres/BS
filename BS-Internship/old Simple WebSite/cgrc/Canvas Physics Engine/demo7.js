...
window.onload = function() {
    ...
    var world = new ParticleWorld(100, 20);
...
//    pfr.registrations.push(pfrn);
    ...
    var temp2 = cgreg1;
    for(var i=0;i<5;i++){
        var particle2 = new Particle(25);
        particle2.position.x = 100;
        particle2.position.y = 70 + 120*i;
        particle2.velocity.x = 100;
        particle2.damping = 1;
        particle2.inverseMass = 1/50;
        ccg.particles.push(particle2);
        var random = 0.3 + Math.random()*0.7;
...
//        pfr.registrations.push(pfrn2);
    ...
    for(var j=0;j<5;j++){
        var random = 10+Math.random()*90;
        var particle2 = new Particle(random/2);
        particle2.position.x = view.size.width-100;
        particle2.position.y = 70 + 120*j;
        particle2.velocity.x = -100;
        particle2.damping = 1;
