...
window.onload = function() {
    ...
    pfrn0.particleForceGenerator = new ParticleBungee(bungeeEnd, 20, 300);
    var path = new Path();
    path.add(bungeeEnd.position);
    path.add(particle.position);
    particle.path = path;
//    path.strokeColor = 'black';
    pfr.registrations.push(pfrn,pfrn0);
    ...
    for(var i=0;i<12;i++){
        ...
        var pd = new ParticleSpring(springEnd, 10, 300);
