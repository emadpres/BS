...
window.onload = function() {
    ...
    //    cgreg.gen=pcgen;
    //    
    var ccg = new CirclesContactGenerator(0.5);
    ...
    //    }
    //    oneMore(new Point(900,view.size.height-210),0);
    oneMore(new Point(780,view.size.height-90),0);
    oneMore(new Point(900,view.size.height-90),0);
    oneMoreCircle(new Point(810,view.size.height-140));
    oneMoreCircle(new Point(930,view.size.height-140));
    oneMoreCircle(new Point(1050,view.size.height-140));
    oneMore(new Point(1020,view.size.height-90),0);
    //    oneMoreBullet(new Point(10,view.size.height));
    function oneMoreBullet(point){
        var particle2 = new Particle(10);
        particle2.position.x = point.x;
        particle2.position.y = point.y;
        particle2.bindedShape.fillColor = 'brown';
        particle2.name = 'orange';
        //        particle2.velocity.y = -300+Math.random()*600;
        particle2.damping = 1;
        particle2.inverseMass = 1/100;
        ...
        var gr = new ParticleGravity();
        gr.gravity = new Point(0,200);
        pfrn6.particleForceGenerator = gr;
        ...
        if(temp2)
            temp2.next = cgreg2;
        temp2 = cgreg2;
        pfr.registrations.push(pfrn4,pfrn6);
        return particle2;
    }
    function oneMoreCircle(point){
        var particle2 = new Particle(30);
        particle2.position.x = point.x;
        particle2.position.y = point.y;
        particle2.bindedShape.fillColor = new HsbColor(Math.random() * 360, 1, 1);
        particle2.name = 'orange';
        //        particle2.velocity.y = -300+Math.random()*600;
        particle2.damping = 0.95;
        particle2.inverseMass = 1/150;
        //        particle2.infiniteMass = true;
        ccg.particles.push(particle2);
        //particle2.bindedShape.fillColor = null;
        //particle2.bindedShape = new Path.Circle(particle2.position,(1.3-random)*50);
        ...
        //        pfr5.particle = particle2;
        //        pfr5.particleForceGenerator = new ParticleBuoyancy(20, 0.8+Math.random()*0.4, 250, 1000);
        var pcgen1 = new BoundryContactGenerator(0.2);
        pcgen1.particles.push(particle2);
        var cgreg2 = new ContactGenRegistration();
        cgreg2.gen=pcgen1;
        if(temp2)
    ...
    function oneMore(point,velx){
        ...
        particle4.bindedShape.fillColor = 'black';
        particle4.name = 'blue';
        //        particle3.velocity.x = -300+Math.random()*600;
        //        particle3.velocity.y = -300+Math.random()*600;
        particle4.damping = 0.95;
        particle4.inverseMass = 1/500;
        ...
        particle5.bindedShape.fillColor = 'black';
        particle5.name = 'green';
        //        particle3.velocity.x = -300+Math.random()*600;
        //        particle3.velocity.y = -300+Math.random()*600;
        particle5.damping = 0.95;
        particle5.inverseMass = 1/500;
        ...
        particle6.bindedShape.fillColor = 'black';
        particle6.name = 'purple';
        //        particle3.velocity.x = -300+Math.random()*600;
        //        particle3.velocity.y = -300+Math.random()*600;
        particle6.damping = 0.95;
        particle6.inverseMass = 1/500;
    ...
    tool.onMouseDown = function(event){
        if(bullet){
            bullet.velocity.x =0;
            bullet.velocity.y =0;
            bullet.position.x = view.size.width;
            bullet.position.y = view.size.height;
            bullet.bindedShape.remove();
        }
        bullet = oneMoreBullet(new Point(10,view.size.height-10));
        path = new Path(new Point(10,view.size.height-10),event.point);
    ...
    tool.onMouseUp = function(event){
        var velocity = new Point(path.segments[1].point.x-path.segments[0].point.x,path.segments[1].point.y-path.segments[0].point.y);
        velocity.length *= 2.5;
