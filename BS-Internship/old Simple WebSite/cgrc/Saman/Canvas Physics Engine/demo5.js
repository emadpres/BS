...
window.onload = function() {
    ...
    for(var i=0;i<13;i++){
        ...
        particle2.position.y = view.size.height - 200 - 200;
        particle2.damping = 1;
        var random = 0.8+Math.random()*0.4;
        particle2.bindedShape = new Path.Rectangle(this.position, new Size(random*50,random*50));
        ...
        pfr5.particleForceGenerator = new ParticleBuoyancy(random*50/2, random, 250, 1000);
