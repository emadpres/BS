...
window.onload = function() {
    ...
    for(var i=0;i<135;i++){
        ...
        particle2.position.x = i*30;
        particle2.position.y = view.size.height - 200 -i/2;
        particle2.damping = 1.05;
        var random = 1;
        particle2.bindedShape = new Path.Rectangle(this.position, new Size(30,30));
        particle2.bindedShape.fillColor = '4B5CD7';
//        particle2.bindedShape.stroke = 'red';
//        particle2.bindedShape.strokeColor = 'red';
        ...
        pfr5.particleForceGenerator = new ParticleBuoyancy(5, random, 250, 1000);
