...
function ParticleGravity(point){
...
window.onload = function() {
    ...
    pfrn.particleForceGenerator = new ParticleGravity(new Point(0,30+Math.random()*120));
    ...
    for(var i=0;i<12;i++){
        ...
        pfrn2.particleForceGenerator = new ParticleGravity(new Point(0,30+Math.random()*120));
        var pfrn3 = new ParticleForceRegistration();
        pfrn3.particle = particle2;
        var pd = new ParticleDrag();
        pd.k1 += 10;
