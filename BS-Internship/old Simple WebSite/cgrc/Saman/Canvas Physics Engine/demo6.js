...
function Particle(){
    ...
    this.bindedShape = new Path.Circle(this.position, 40);
...
window.onload = function() {
    ...
    particle.position.y = view.size.height/2;
    ...
    var pcgen = new BoundryContactGenerator(0.5);
    ...
    for(var i=0;i<8;i++){
        ...
        particle2.position.x = 200 + i*150;
        particle2.position.y = view.size.height/2;
        particle2.damping = 1;
        ...
        var pcgen1 = new BoundryContactGenerator(random);
