...
//    pfr.registrations.push(pfrn);
    ...
    for(var i=0;i<4;i++){
        ...
        var particle2 = new Particle(random/2);
        particle2.position.x = 400;
        particle2.position.y = 100 + 100*i;
        particle2.velocity.x = -300+Math.random()*600;
        particle2.velocity.y = -300+Math.random()*600;
        particle2.damping = 1;
        particle2.inverseMass = 1/random;
        ...
        random = 50+Math.random()*50;
        var particle3 = new Particle(random/2);
        particle3.position.x = 700;
        particle3.position.y = 100 + 100*i;
        particle2.velocity.x = -300+Math.random()*600;;
        particle2.velocity.y = -300+Math.random()*600;;
        particle3.damping = 1;
...
//        cable.path.fullySelected = true;
        var cgreg4 = new ContactGenRegistration();
        cgreg4.gen = cable;
        temp2.next = cgreg4;
        temp2 = cgreg4;
//        pfr.registrations.push(pfrn2,pfrn4);
        //        var path = new Path();
