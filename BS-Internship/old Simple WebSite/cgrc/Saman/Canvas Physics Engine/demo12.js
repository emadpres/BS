...
window.onload = function() {
    ...
    var ccg = new CirclesContactGenerator(0.9);
...
//    pfr.registrations.push(pfrn);
    ...
    for(var i=0;i<4;i++){
        ...
        particle2.position.x = 200 + i*300;
        particle2.position.y = randomPos.y;
        particle2.bindedShape.fillColor = 'black';
//        particle2.velocity.x = -300+Math.random()*600;
//        particle2.velocity.y = -300+Math.random()*600;
        particle2.damping = 1;
        particle2.inverseMass = 0;
        ...
        var particle3 = new Particle(random/2);
        particle3.position.x = 200 + i*300 -100 + Math.random()*200;
        particle3.position.y = randomPos.y + Math.random()*100;
//        particle3.velocity.x = -300+Math.random()*600;
//        particle3.velocity.y = -300+Math.random()*600;
        particle3.damping = 1;
        particle3.inverseMass = 1/random;
...
//        pfrn3.particleForceGenerator = pd;
        ...
        cable.maxLength = 250 + Math.random()*200;
        cable.particle.push(particle2,particle3);
        cable.restitution = 0.9;
        cable.path = new Path(particle2.position,new Point(particle2.position.x + (particle3.position.x -particle2.position.x)/2,particle2.position.y + (particle3.position.y - particle2.position.y)/2),particle3.position);
