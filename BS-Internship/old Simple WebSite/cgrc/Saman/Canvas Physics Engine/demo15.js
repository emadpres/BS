...
window.onload = function() {
    ...
    var world = new ParticleWorld(100, 0);
...
//    pfr.registrations.push(pfrn);
    ...
    var temp2 = cgreg1;
    for(var i=0;i<2;i++){
        var randomlength = 250 + Math.random()*200;
        var randomPos = new Point(200+Math.random()*(view.size.width-200),Math.random()*view.size.height/2);
        var particle2 = new Particle(30);
        particle2.position.x = view.size.width/2;
        particle2.position.y = 100 + i*100;
        particle2.bindedShape.fillColor = 'black';
        particle2.velocity.x = -300+Math.random()*800;
        particle2.velocity.y = -300+Math.random()*800;
        particle2.damping = 1;
...
//        particle2.infiniteMass = true;
        ...
        var random = 50+Math.random()*50;
        var particle3 = new Particle(30);
        particle3.position.x = view.size.width/2 + randomlength;
        particle3.position.y = 100 + i*100;
...
//        particle3.velocity.y = -300+Math.random()*600;
        ...
        particle4.position.x = view.size.width/2 -300;
        particle4.position.y = 100 + i*100;
//        particle3.velocity.x = -300+Math.random()*600;
//        particle3.velocity.y = -300+Math.random()*600;
        particle4.damping = 1;
...
//        pfrn3.particleForceGenerator = pd;
        ...
        var pcgen1 = new BoundryContactGenerator(1);
        ...
        var pcgen2 = new BoundryContactGenerator(1);
        ...
        var pcgen3 = new BoundryContactGenerator(1);
...
//        rod.restitution = 0.9;
        ...
        var cable = new ParticleCable();
        cable.maxLength = 300;
        cable.particle.push(particle2,particle4);
        cable.restitution = 1;
        cable.path = new Path(particle2.position,new Point(particle2.position.x + (particle4.position.x -particle2.position.x)/2,particle2.position.y + (particle4.position.y - particle2.position.y)/2),particle4.position);
        cable.path.strokeColor = 'green';
        cable.path.strokeWidth = 5;
        cable.path.strokeCap = 'round'; 
        var cgreg6 = new ContactGenRegistration();
        cgreg6.gen = cable;
        temp2.next = cgreg6;
        temp2 = cgreg6;
//        pfr.registrations.push(pfrn2);
        //        var path = new Path();
